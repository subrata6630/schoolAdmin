...
<footer id="footer">
					...
					<div class="widget">
						...
						<div class="footer-menu">
							<ul class="nav flex-column">
								...
								<li class="nav-item">
									<a class="nav-link" href="all-notice.php">Notice</a>
								</li>
				...
				<div class="col-lg-3">
					<div class="widget">
						...
						<div class="footer-events">
							<ul class="nav flex-column">
								<a class="nav-link active" href="single-news.php">Art Competition</a>
								<a class="nav-link active" href="single-news.php">Study Tour</a>
								<a class="nav-link active" href="single-news.php"> Annual Picnic</a>
								<a class="nav-link active" href="single-news.php">International Mother Language Day</a>
								<a class="nav-link active" href="single-news.php">Islamic Competition</a>
								<a class="nav-link active" href="single-news.php"> Independence day</a>
								<a class="nav-link active" href="single-news.php">  Summer camp </a>
	    ...
	    <div class="copyright">
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-4 ml-0">
						<p>Develop By <a href="https://www.webcivic.com" target="_blank">Webcivic Technologies</a> </p>
					</div>
				</div>
			</div>
		</div>
	...
	<!-- lazy loader scripts js -->
	<script src="assets/js/jquery.lazy.plugins.min"></script>
	<script>
